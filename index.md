...
- 2020年12月 情報処理学会 インターネットと運用技術研究会 第13回インターネットと運用技術シンポジウム(IOTS2020) プログラム委員
- 2020年07月 情報処理学会 第50回インターネットと運用技術研究会(IOT50）プログラム委員長
...
- 分散アプリケーションにおける機械学習および因果推論による根本原因の診断
...
1. [2020年度 情報処理学会 山下記念研究賞]()，坪内佑樹，Transtracer: 分散システムにおけるTCP/UDP通信の終端点の監視によるプロセス間依存関係の自動追跡，2020年．(to appear)
...
1. <u>坪内佑樹</u>, 鶴田博文, 古川雅大, **[TSifter: マイクロサービスにおける性能異常の 迅速な診断に向いた時系列データの次元削減手法]()**, [インターネットと運用技術シンポジウム論文集, 2020](https://www.iot.ipsj.or.jp/symposium/iots2020-program/), 2020年12月. (to appear)
